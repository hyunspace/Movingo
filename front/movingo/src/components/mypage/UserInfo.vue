  ...
  <div id="userinfo">
    ...
    <div :class="{ hide: isMe }">
      <div v-if="followed" class="text-center">
        <button @click="followUser(profile.pk)" class="follow-button"><i class="movie-like bi bi-heart-fill"></i></button>
      </div>
      <div v-if="!followed" class="text-center">
        <div v-if="isMe">
          <i class="movie-like bi bi-heart-fill"></i>
        </div>
        <div v-else>
          <button @click="followUser(profile.pk)" class="follow-button"><i class="movie-like bi bi-heart"></i></button>
        </div>
      </div>      
    </div>
    <div id="infos">
