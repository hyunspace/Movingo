  ...
  <div id="mypagenav">
    ...
    <div class="tab-content" id="nav-tabContent">
      ...
      <div class="tab-pane fade active" id="nav-wishlist" role="tabpanel" aria-labelledby="nav-wishlist-tab">
        <wish-list :movies="profile.wish_movies" :username="profile.profile_info[0].nickname"></wish-list>
      </div>
      <div class="tab-pane fade active" id="nav-collections" role="tabpanel" aria-labelledby="nav-collections-tab">
        <user-collections :collections="ordered_collections" :nickname="profile.profile_info[0].nickname"></user-collections>
      </div>
      <div class="tab-pane fade active" id="nav-reviews" role="tabpanel" aria-labelledby="nav-reviews-tab">
        <user-reviews :reviews="profile.reviews"></user-reviews>
      </div>      
    </div>
  </div>
...
import UserReviews from './nav/UserReviews'
